...
class Message {
    constructor() {
        const element = document.createElement("div");
        element.className = "rounded w-full text-center";
...
class Board {
    ...
    _updateMessage(curr, next) {
        ...
        next.setText("あいてのばん");
        remove_and_add(next.element,
            ["text-" + config.curr_font_color, "bg-" + config.curr_bg_color],
            ["text-" + config.next_font_color, "bg-" + config.next_bg_color]);

        curr.setText("じぶんのばん");
        remove_and_add(curr.element,
            ["text-" + config.next_font_color, "bg-" + config.next_bg_color],
            ["text-" + config.curr_font_color, "bg-" + config.curr_bg_color]);
